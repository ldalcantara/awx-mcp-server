...
class TestJobTemplates:
    ...
    async def test_get_job_template_by_id(self, awx_client):
        ...
        if templates:
            ...
            ), f"Should get template with ID {template_id}"
...
class TestProjects:
    ...
    async def test_update_project(self, awx_client):
        ...
        if projects:
            ...
            assert (
                "project_update_id" in result or "message" in result
...
class TestInventories:
    ...
    async def test_get_inventory_by_id(self, awx_client):
        ...
        if inventories:
            ...
            ), f"Should get inventory with ID {inventory_id}"
